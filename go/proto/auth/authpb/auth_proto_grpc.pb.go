...
type AuthServiceClient interface {
	GeneratePassword(ctx context.Context, in *BcryptPasswordRequest, opts ...grpc.CallOption) (*BcryptPasswordResponse, error)
...
func (c *authServiceClient) GeneratePassword(ctx context.Context, in *BcryptPasswordRequest, opts ...grpc.CallOption) (*BcryptPasswordResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BcryptPasswordResponse)
...
type AuthServiceServer interface {
	GeneratePassword(context.Context, *BcryptPasswordRequest) (*BcryptPasswordResponse, error)
...
func (UnimplementedAuthServiceServer) GeneratePassword(context.Context, *BcryptPasswordRequest) (*BcryptPasswordResponse, error) {
...
func _AuthService_GeneratePassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GeneratePassword(ctx, req.(*BcryptPasswordRequest))
	}
